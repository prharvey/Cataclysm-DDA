...
struct level_cache {
    public:
        ...
        cata::mdarray<four_quadrants, point_bub_ms_ib> lm;
        cata::mdarray<float, point_bub_ms_ib> sm;
        ...
        cata::mdarray<bool, point_bub_ms_ib> outside_cache;
        ...
        // false otherwise
        // i.e. true == has floor
        cata::mdarray<bool, point_bub_ms_ib> floor_cache;
        ...
        cata::mdarray<float, point_bub_ms_ib> vision_transparency_cache;

        // stores "visibility" of the tiles to the player
        // values range from 1 (fully visible to player) to 0 (not visible)
        cata::mdarray<float, point_bub_ms_ib> seen_cache;
        ...
        cata::mdarray<float, point_bub_ms_ib> camera_cache;
